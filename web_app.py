...
<body>
    <div class="card">
        ...
        {% else %}
            <p style="color:#27ae60; font-weight:bold; font-size:14px;">📩 OTP Sent to Your Email!</p>
            <form method="POST">
...
def login():
    ...
    if request.method == 'POST':
        ...
        if step == 'send_otp':
            ...
            # Handle Uploaded Profile Pic on Sign Up
            ...
            if "@" in user_id and "." in user_id:
                ...
                if send_email_otp(user_id, gen_otp):
                    otp_sent = True
                else:
                    msg = "❌ Email send karne me problem aayi. Check Gmail App Password."
            else:
            ...
            if entered_otp and entered_otp == correct_otp:
                ...
                otp_sent = True
                msg = "❌ Galat OTP! Email par aaya OTP dalein."
